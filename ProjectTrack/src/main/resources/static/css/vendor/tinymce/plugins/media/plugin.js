    ...
    const register = editor => {
      ...
      editor.ui.registry.addToggleButton('media', {
        ...
        onSetup: buttonApi => {
          ...
          const unbindSelectorChanged = selection.selectorChangedWithUnbind('images[data-mce-object],span[data-mce-object],div[data-ephox-embed-iri]', buttonApi.setActive).unbind;
