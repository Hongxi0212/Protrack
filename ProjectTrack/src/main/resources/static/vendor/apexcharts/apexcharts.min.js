        ...
        return r(t, [{
            key: "draw", value: function (t, i, a, s) {
                ...
                for (var c = [], d = 0; d < t.length; d++) {
                    ...
                    var u = [], p = [], f = [], x = r.globals.padHorizontal + this.categoryAxisCorrection;
                    ...
                    var b, v = x, w = void 0, k = v, A = this.zeroY, S = this.zeroY;
            ...
            key: "_iterateOverDataPoints", value: function (t) {
                var e = t.type, i = t.series, a = t.iterations, s = t.realIndex, r = t.i, o = t.x, n = t.y, l = t.pX,
                    ...
                    f = t.xArrj, b = t.yArrj, v = t.y2Arrj, y = t.isRangeStart, w = t.seriesRangeEnd, k = this.w,
                    A = new m(this.ctx), S = this.yRatio, C = c.prevY, L = c.linePath, P = c.areaPath,
                    I = c.pathFromLine, T = c.pathFromArea,
                ...
                for (var X = n, z = 0; z < a; z++) {
                    ...
                    if (k.config.chart.stacked) if (r > 0 && k.globals.collapsedSeries.length < k.config.series.length - 1) {
