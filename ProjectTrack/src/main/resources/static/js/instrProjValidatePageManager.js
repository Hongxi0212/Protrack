...
<!--            Dynamic Generated Phases Date-->
        ...
        <div class="row mb-3">
            ...
            <div class="col-md-10">
                <textarea id="rubric_textarea" name="rubric" class="form-control" style="height: 100px" disabled>${project.rubric}</textarea>
            </div>
        </div>
        ...
        <div class="row mb-3">
            ...
            <div class="col-10">
                <table class="table table-bordered">
                    ...
                    <tbody>
                    <tr>
                        <td><textarea id="strength_stu_textarea" class="form-control" disabled>${project.strengthStu}</textarea></td>
                        <td><textarea id="strength_instr_textarea" class="form-control">${project.strengthInstr}</textarea></td>
                    </tr>
                    </tbody>
                </table>
            </div>
            ...
            <div class="col-10"> 
                <table class="table table-bordered">
                    ...
                    <tbody>
                    <tr>
                        <td><textarea id="weakness_stu_textarea" class="form-control" disabled>${project.weaknessStu}</textarea></td>
                        <td><textarea id="weakness_instr_textarea" class="form-control">${project.weaknessInstr}</textarea></td>
                    </tr>
                    </tbody>
                </table>
            </div>
            ...
            <div class="col-10"> 
                <table class="table table-bordered">
                    ...
                    <tbody>
                    <tr>
                        <td><textarea id="error_stu_textarea" class="form-control" disabled>${project.errorStu}</textarea></td>
                        <td><textarea id="error_instr_textarea" class="form-control">${project.errorInstr}</textarea></td>
                    </tr>
                    </tbody>
                </table>
            </div>
            ...
            <div class="col-10"> 
                <table class="table table-bordered">
                    ...
                    <tbody>
                    <tr>
                        <td><textarea id="comment_stu_textarea" class="form-control" disabled> ${project.commentStu}</textarea></td>
                        <td><textarea id="comment_instr_textarea" class="form-control">${project.commentInstr}</textarea></td>
                    </tr>
                    </tbody>
                </table>
            </div>
